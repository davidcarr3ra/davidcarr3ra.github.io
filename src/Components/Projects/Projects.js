      ...
      <div className="projects">
      	...
      	<div className="row mb5">
            ...
            <div className="project_box br4 ba w-100-l shadow-5 pa4 bg-white">
              ...
              <img src="images/portfolio/poker.png" alt="" width="200px"/>
            ...
            <div className="project_box br4 ba w-100-l shadow-5 pa4 bg-white"> 
              ...
              <a target="_blank" rel="noopener noreferrer" href="https://my-face-recog.herokuapp.com/" className="hvr-sweep-to-right br3">See Live</a>
            </div>
            <div className="project_box br4 ba w-100-l shadow-5 pa4 bg-white"> 
              <p className="mb2 mt2 f2 fw6" style={{color: "#16464B"}}>Gaussian Elimination Visualizer</p>
              <img className="mb4" alt="" src="images/portfolio/gaussian.png" width="215px"/>
